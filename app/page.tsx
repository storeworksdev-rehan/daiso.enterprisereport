...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left panel : branding */}
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-[#1a1a1a] px-12 py-10 relative overflow-hidden">
        <video
          autoPlay
          loop
          muted
          ...
          src="/stock-videos/abstract-background.mp4"
          type="video/mp4"
        />
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-slate-50 px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8 flex items-center gap-2 lg:hidden">
            ...
            />
            <span className="font-semibold text-slate-900">Daiso Enterprise</span>
          </div>
          ...
          <form onSubmit={handleLogin} className="mt-8 space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-slate-300 bg-white px-3.5 py-2.5 text-sm text-slate-900 placeholder-slate-400 shadow-sm outline-none transition focus:border-[#e60081] focus:ring-2 focus:ring-[#e60081]/40"
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <a
                  href="#"
                  className="text-xs font-medium text-[#e60081] hover:text-[#c40070] transition"
                >
                  Forgot password?
                </a>
              </div>
            ...
            <button
              ...
              className="w-full rounded-md bg-[#e60081] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#c40070] focus:outline-none focus:ring-2 focus:ring-[#e60081] focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"
            >
              {status === "loading" ? (
            ...
            <div
              className={`mt-5 flex items-start gap-3 rounded-md px-4 py-3 text-sm ${
                status === "success"
                  ...
                  : "bg-[#fff0f7] text-[#e60081] border border-[#f9c0e0]"
              }`}
            >
              {status === "success" ? (
                <svg
                ...
                <svg
                  className="mt-0.5 h-4 w-4 shrink-0 text-[#e60081]"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
