      ...
      <div className="space-y-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex h-9 items-center gap-2 rounded-lg bg-[#e60081] px-4 text-sm font-semibold text-white shadow-sm hover:bg-[#c40070] transition-colors"
          >
        ...
        {error && (
          <div className="rounded-lg border border-[#f9c0e0] bg-[#fff0f7] px-4 py-3 text-sm text-[#e60081]">
            {error}
          </div>
        )}
        {saveSuccess && (
        ...
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="flex items-center gap-3 border-b border-slate-100 px-5 py-4">
            <MapPin className="h-4 w-4 text-[#e60081]" />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col items-center justify-center gap-2 pt-10 self-center">
                    <button
                      ...
                      className="flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 shadow-sm transition-colors hover:border-[#e60081] hover:bg-[#e60081] hover:text-white disabled:cursor-not-allowed disabled:opacity-40"
                    >
            ...
            <form onSubmit={handleCreateRegion} className="px-5 py-5 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-300 bg-white px-3.5 py-2.5 text-sm text-slate-900 placeholder-slate-400 shadow-sm outline-none transition focus:border-[#e60081] focus:ring-2 focus:ring-[#e60081]/20"
                />
              </div>

              {createError && (
                <p className="text-xs font-medium text-[#e60081]">
                  {createError}
                </p>
              )}
