  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-xl border border-slate-200 bg-white px-5 py-4 shadow-sm">
        <div className="flex flex-wrap items-end gap-4">
          ...
          <div className="flex flex-col gap-1.5 min-w-[200px]">
            ...
            <div className="relative" ref={locRef}>
              <button
                ...
                className="flex h-9 w-full items-center justify-between rounded-lg border border-slate-200 bg-slate-50 px-3 text-sm text-slate-700 outline-none focus:border-[#e60081] focus:ring-2 focus:ring-[#e60081]/20 transition"
              >
                  ...
                  <div className="p-2 border-b border-slate-100">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="h-8 w-full rounded-lg border border-slate-200 bg-slate-50 pl-8 pr-3 text-xs text-slate-700 placeholder-slate-400 outline-none focus:border-[#e60081]"
                      />
                    </div>
                  </div>
                  <ul className="max-h-52 overflow-y-auto py-1">
                    <li>
                      <button
                        ...
                        className={`flex w-full items-center gap-2 px-3 py-2 text-left text-xs hover:bg-slate-50 transition-colors ${locationIds.length === 0 ? "font-semibold text-[#e60081]" : "text-slate-600"}`}
                      >
                        <input
                          type="checkbox"
                          readOnly
                          checked={locationIds.length === 0}
                          className="h-3.5 w-3.5 accent-[#e60081] shrink-0"
                        />
                        All Locations
                      </button>
                    </li>
                        ...
                        return (
                          <li key={loc.Id}>
                            <button
                              ...
                              className={`flex w-full items-center gap-2 px-3 py-2 text-left text-xs hover:bg-slate-50 transition-colors ${checked ? "font-semibold text-[#e60081]" : "text-slate-700"}`}
                            >
                              <input
                                type="checkbox"
                                readOnly
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="h-9 w-40 rounded-lg border border-slate-200 bg-slate-50 pl-8 pr-8 text-sm text-slate-700 placeholder-slate-400 outline-none focus:border-[#e60081] focus:ring-2 focus:ring-[#e60081]/20 transition disabled:cursor-not-allowed disabled:opacity-40"
              />
              {transactionNumber && (
                <button
                  type="button"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input
                ...
                maxLength={10}
                className={`h-9 w-36 rounded-lg border bg-slate-50 pl-3 pr-8 text-sm text-slate-700 placeholder-slate-400 outline-none focus:ring-2 transition ${filterError && ((fromDate && fromDate.length < 10) || (!fromDate && toDate)) ? "border-[#e60081] focus:border-[#e60081] focus:ring-[#e60081]/20" : "border-slate-200 focus:border-[#e60081] focus:ring-[#e60081]/20"}`}
              />
              <button
                type="button"
                onClick={() => fromRef.current?.showPicker()}
                className="absolute inset-y-0 right-2 flex items-center text-slate-400 hover:text-[#e60081] transition-colors"
              >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input
                ...
                placeholder="MM/DD/YYYY"
                maxLength={10}
                className={`h-9 w-36 rounded-lg border bg-slate-50 pl-3 pr-8 text-sm text-slate-700 placeholder-slate-400 outline-none focus:ring-2 transition ${filterError && ((toDate && toDate.length < 10) || (!toDate && fromDate)) ? "border-[#e60081] focus:border-[#e60081] focus:ring-[#e60081]/20" : "border-slate-200 focus:border-[#e60081] focus:ring-[#e60081]/20"}`}
              />
              <button
                type="button"
                onClick={() => toRef.current?.showPicker()}
          ...
          <div className="flex items-end gap-2">
            <button
              onClick={handleApply}
              disabled={loading}
              className="flex h-9 items-center gap-2 rounded-lg bg-[#e60081] px-4 text-sm font-semibold text-white hover:bg-[#c40070] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
            >
        ...
        {filterError && (
          <p className="mt-3 text-xs font-medium text-[#e60081]">
            {filterError}
          </p>
        )}
      </div>
          ...
          {tab === "flat" && (
            <div className="flex items-center gap-3 py-2">
              ...
              <select
                ...
                disabled={loading}
                className="h-8 rounded-lg border border-slate-200 bg-slate-50 px-3 text-xs text-slate-700 outline-none focus:border-[#e60081] focus:ring-2 focus:ring-[#e60081]/20 disabled:opacity-50"
              >
          ...
          {tab === "hierarchy" && !loading && filtered.length > 0 && (
            <div className="flex items-center gap-2 py-2">
              <button
                ...
                className="text-xs text-slate-500 hover:text-[#e60081] transition-colors"
              >
                Expand all
              </button>
                  ...
                  return range.map((item, idx) =>
                    item === "…" ? (
                      ...
                      <button
                        ...
                        disabled={loading}
                        className={`h-7 min-w-7 rounded-md border px-1 text-xs transition-colors ${item === page ? "border-[#e60081] bg-[#e60081] text-white font-semibold" : "border-slate-200 text-slate-600 hover:bg-slate-50"}`}
                      >
                        {item}
                      </button>
                    ),
