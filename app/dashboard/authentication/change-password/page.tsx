  ...
  const field = (
    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className={`w-full rounded-lg border bg-white px-3.5 py-2.5 pr-10 text-sm text-slate-900 placeholder-slate-400 shadow-sm outline-none transition
            focus:ring-2 focus:ring-[#e60081]/20 focus:border-[#e60081]
            ${key === "ConfirmPassword" && mismatch ? "border-[#e60081]" : "border-slate-300"}`}
        />
        <button
          type="button"
      ...
      {key === "ConfirmPassword" && mismatch && (
        <p className="mt-1 text-xs text-[#e60081]">Passwords do not match.</p>
      )}
    </div>
  );
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
          <div className="border-b border-slate-100 bg-slate-50 px-6 py-4 flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#e60081]/10">
              <KeyRound className="h-4 w-4 text-[#e60081]" />
            </div>
            <div>
