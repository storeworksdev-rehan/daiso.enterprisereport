        ...
        <div className="flex w-[2/3] shrink-0 flex-col rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="flex items-center justify-between border-b border-slate-100 px-4 py-4">
            <div className="flex items-center gap-2">
              <Users className="h-4 w-4 text-[#e60081]" />
          ...
          {/* Error */}
          {error && !panel && (
            <p className="border-b border-[#f9c0e0] bg-[#fff0f7] px-4 py-2 text-xs font-medium text-[#e60081]">
              {error}
            </p>
          )}
                ...
                <tbody className="divide-y divide-slate-50">
                  {filtered.map((user) => {
                    ...
                    return (
                      <tr
                        key={user.UserId}
                        className={`transition-colors hover:bg-slate-50 ${active ? "bg-[#fff0f7]" : ""}`}
                      >
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2.5">
                            ...
                            <div>
                              <p
                                className={`font-medium leading-none ${active ? "text-[#e60081]" : "text-slate-700"}`}
                              >
                                {user.Username}
                              </p>
                            </div>
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            <button
                              ...
                              title="Delete"
                              className="flex h-7 w-7 items-center justify-center rounded-md bg-[#fff0f7] text-[#e60081] hover:bg-[#ffe0f3] transition-colors"
                            >
        ...
        {panel === "edit" && (
          <div className="flex flex-1 flex-col rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm text-slate-800 placeholder-slate-400 outline-none focus:border-[#e60081] focus:ring-2 focus:ring-[#e60081]/10 transition"
                />
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 pr-10 text-sm text-slate-800 placeholder-slate-400 outline-none focus:border-[#e60081] focus:ring-2 focus:ring-[#e60081]/10 transition"
                    />
                    <button
                      type="button"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full appearance-none rounded-lg border border-slate-200 bg-slate-50 py-2.5 pl-9 pr-4 text-sm text-slate-800 outline-none focus:border-[#e60081] focus:ring-2 focus:ring-[#e60081]/10 transition"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex w-full items-center justify-between gap-2 rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm text-slate-800 outline-none focus:border-[#e60081] focus:ring-2 focus:ring-[#e60081]/10 transition"
                  >
                            ...
                            <li key={r.Id}>
                              <label className="flex cursor-pointer items-center gap-2.5 px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
                                <input
                                  ...
                                  className="h-3.5 w-3.5 rounded border-slate-300 accent-[#e60081]"
                                />
                                {r.Name}
                              </label>
                            </li>
            ...
            <div className="flex items-center justify-between border-t border-slate-100 bg-slate-50 px-6 py-4">
              {error ? (
                <p className="text-xs font-medium text-[#e60081]">{error}</p>
              ) : (
                <span />
              )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="w-full max-w-sm rounded-xl border border-slate-200 bg-white shadow-2xl">
            <div className="flex items-start gap-4 p-6">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#ffe0f3]">
                <Trash2 className="h-5 w-5 text-[#e60081]" />
              </div>
              <div>
