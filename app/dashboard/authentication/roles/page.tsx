      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-100 px-4 py-4">
          <div className="flex items-center gap-2">
            <Shield className="h-4 w-4 text-[#e60081]" />
                  ...
                  <li key={role.RoleId}>
                    <button
                      ...
                      className={`flex w-full items-center justify-between px-4 py-3.5 text-left transition-colors hover:bg-slate-50 ${
                        active ? "bg-[#fff0f7] border-l-2 border-[#e60081]" : ""
                      }`}
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p
                            className={`text-sm font-medium ${active ? "text-[#e60081]" : "text-slate-700"}`}
                          >
                            {role.RoleName}
                          </p>
                        ...
                        <div className="flex items-center gap-3 justify-between">
                          <div>
                            <input
                              ...
                              className="h-4 w-4 rounded border-slate-300 accent-[#e60081]"
                            />
                          </div>
                          <div>
