          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="relative mb-6 select-none">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="h-1.5 w-40 rounded-full bg-[#e60081] opacity-80" />
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-[#e60081] px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#c40070] transition-colors"
              >
