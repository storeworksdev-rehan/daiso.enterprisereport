  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-slate-200 bg-[#1a1a1a] px-6">
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#e60081] text-xs font-semibold text-white">
            {initials}
          </div>
          ...
          <div className="absolute right-0 top-full z-50 mt-2 w-48 rounded-xl border border-slate-200 bg-white py-1 shadow-lg">
            ...
            <div className="border-t border-slate-100 mt-1">
              <button
                ...
                className="flex w-full items-center gap-2.5 px-4 py-2.5 text-sm text-[#e60081] hover:bg-[#fff0f7] transition-colors"
              >
